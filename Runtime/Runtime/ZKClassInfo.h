...
#ifndef ZKClassInfo_h
#define ZKClassInfo_h
...
/* OC对象 */
struct zk_objc_object {
    void *isa;
};

/* 类对象 */
struct zk_objc_class : zk_objc_object {
    Class superclass;
    cache_t cache;
...
public:
    ...
    zk_objc_class* metaClass() {
        return (zk_objc_class *)((long long)isa & ISA_MASK);
    }
};
